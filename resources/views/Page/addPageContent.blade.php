            ...
            <form class="form-horizontal" action="{{route('addcontent',['id'=>$id])}}" method="post" enctype="multipart/form-data">
              ...
              <div class="box-body">
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="url" placeholder="Enter Page Content URl" name="url">
                  </div>
                </div>
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  <label for="inputPassword3" class="col-sm-2 control-label">Page Content Status</label>
