...
$public_url = env('SITE_URL');    // http://marketadmin.localhost/
...
return [
    ...
    'PRODUCTS_STORAGE_DIR'=>$public_url.DIRECTORY_SEPARATOR."storage".DIRECTORY_SEPARATOR."app".DIRECTORY_SEPARATOR."public".DIRECTORY_SEPARATOR."uploads".DIRECTORY_SEPARATOR."products",
